...
Here, the key output metrics are: <br><br>
...
Reduced model has a better elpd_diff (= + 3.0), meaning the model is expected to predict new data better than the original model based on LOO-CV as the metric of comparison. <br><br>
...
Therefore I set `Inverse-Gamma` distribution (\sim) \((\alpha = 1, \beta = 1)\) as a prior for the parameters of the modulators, and use the following model to estimate the parameters of the modulators.
...
Stan code for the model simulation <br><br>
...
<br><br>
Check the result of the model <br><br>
...
<br><br>
Bayesian model selection <br><br>
...
<br><br>
Create a contour plot of the posterior predictive mean of conversion as a function of concentration settings <br><br>
...
Here, I created a contour plot of the posterior predictive mean of conversion as a function of concentration settings to visualize the relationship between the modulators and conversion. <br><br>
...
I will use these ranges to create the second experiment design. <br><br>

...
formula_vec <- c(spend ~ treatment + recency + channel, # model A (alpha_i)
                 spend ~ treatment + recency + channel + history, # model B (beta_i)
                 history ~ treatment + channel + recency) # model C (gamma_i)
